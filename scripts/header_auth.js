...
let headerInner = `
      <div class="container header">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0 header__nav">
          ...
          <li><a id="terms-link" href="/emergency/termsOfUse" class="nav-link px-2 link-dark header__link">Правила</a></li>
        ...
        <div class="text-end">
          <button type="button" class="btn btn-outline-light me-2 header__login">Профиль</button>
          <a href="https://www.google.ru"><button type="button" class="btn btn-warning">ВЫХОД</button></a>
        </div>
        </div>
      </div>
`;
